	...
	public render(): React.ReactNode {
		...
		const seconds = (
			<InputAdornment position='end'>
				{SettingsLocalization.videoTab.seconds(language)}
			</InputAdornment>
		);
		...
		const fadeIn = (
			<div className='white-space-nowrap'>
				<FormControlLabel
					...
					label={SettingsLocalization.videoTab.fadeIn(language)}
				/>
			</div>
		);
		...
		const fadeOut = (
			<div className='white-space-nowrap'>
				<FormControlLabel
					...
					label={SettingsLocalization.videoTab.fadeOut(language)}
				/>
			</div>
		);
				...
				>
					...
					>
						...
						>
							...
							<Select
								// label={SettingsLocalization.videoTab.fitWithin(language)}
