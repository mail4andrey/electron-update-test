...
import type { ClipmakerSettingsModel } from './settings/ClipmakerSettingsModel';
...
export class Clipmaker {
	...
	public static run(): void {
		...
		/**  */
		const getSettings = (app?: Electron.App) => settingsСontroller.loadDefaultSettings<ClipmakerSettingsModel>(app);
